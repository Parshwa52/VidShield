  ...
  const registerCreate = async (event) => {
    ...
    if (contract) {
      if (metaTxEnabled) {
        ...
        let functionSignature = contract.methods.registerCreator(userAddress).encodeABI();
        let message = {};
        ...
        contract.methods
          .registerCreator(selectedAddress)
    ...
    if (web3 && contract) {
      try {
        ...
        tx.on("transactionHash", function(hash) {
          ...
          alert("You have successfully registered as creator");
            ...
            <div className="container">
              <div className="row">
                ...
                {" "}
                  ...
                  <form>
                  <button
                    onClick={(event)=>registerCreate(event)}
                    className="btn btn-custom btn-lg page-scroll"
                  >
                    Register
                  </button>
